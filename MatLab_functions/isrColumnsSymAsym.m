function [Inertia_xy_modif,b,h,bestArrangement,bestDisposition,costElemCol,...
    Ac_sec_elem,Ef_sec_col,Mr_col,bestCFA]=isrColumnsSymAsym(pu_cols,height,b,...
    h,rec,fy,fc,load_conditions,cols_sym_asym_isr,condition_cracking,...
    ductility,wac,RebarAvailable,puCostCardBuild,dataCFA,optimaPlot,...
...
%
%         pu_cols:                  is the average unit cost of
...
if cols_sym_asym_isr=="Symmetric"
    ...
    Ef_sec_col,bestArrangement,bestDisposition,nv4,bestcxy,bestCFA]=...
    superOptimalRebarSym(b,h,rec,Ac_sec_elem,E,npdiag,fdpc,betac,...
    load_conditions,wac,height,condition_cracking,ductility,RebarAvailable,...
...
elseif cols_sym_asym_isr=="Asymmetric"
    ...
    bestArrangement,bestDisposition,Mr_col,bestcxy,bestCP,costElemCol,bestCFA]=...
    AssembledRebarSymAsym2(b,h,rec,Ac_sec_elem,E,npdiag,fdpc,betac,height,...
    wac,RebarAvailable,load_conditions,condition_cracking,...

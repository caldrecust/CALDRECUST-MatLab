function [root]=rootMrColSym3DiamRot(c1,c2,fr,Es,h,b,fcu,...
        ea,nb1,nb2,nb3,db1,db2,db3,distrRebar,RotCornerSec,gamma)
...
depthRotCP=max(RotCornerSec(:,2));

fy=Es*0.00217;
listRebarDiam=[repmat(db1,nb1,1);repmat(db2,2*nb2,1);repmat(db3,2*nb3,1)];

%%%%%%%%%%%%%%%%%%%%%% f(l) %%%%%%%%%%%%%%%%%%%%%%%
[Mr1,Fr1]=strElasBars1RecBlockColRot(c1,fcu,h,b,fy,Es,distrRebar,...
    listRebarDiam,RotCornerSec,depthRotCP,gamma);
root1=fr-Fr1;

%%%%%%%%%%%%%%%%%%%%%% f(u) %%%%%%%%%%%%%%%%%%%%%%% 
[Mr2,Fr2]=strElasBars1RecBlockColRot(c2,fcu,h,b,fy,Es,distrRebar,...
    listRebarDiam,RotCornerSec,depthRotCP,gamma);
root2=fr-Fr2;
...
[Mr,Fr]=strElasBars1RecBlockColRot(c,fcu,h,b,fy,Es,distrRebar,...
    listRebarDiam,RotCornerSec,depthRotCP,gamma);
rootc=fr-Fr;

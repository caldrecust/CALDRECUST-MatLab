function [b,h,bestArrangement,bestDisposition,costElemCol,AcSecElm,...
    EfsecCol,Mrcol,bestLoad,bestCFA]=isrColsSymAsymIntSurf(puCols,height,b,h,rec,...
    fy,fc,load_conditions,cols_sym_asym_isr,ductility,wac,RebarAvailable,...
    puCostCardBuild,dataCFA,optimaPlot,plotsISRdiagrams,plotRebarDesign)
%------------------------------------------------------------------------
% Syntax:
% [b,h,bestArrangement,bestDisposition,costElemCol,Ac_sec_elem,...
%  Ef_sec_col,Mr_col,bestLoad,bestCFA]=isrColsSymAsymIntSurf(puCols,height,b,h,rec,fy,...
...
elseif cols_sym_asym_isr=="Asymmetric"
    ...
    Mrcol,bestcxy,bestCP,costElemCol,bestLoad,bestCFA]=AssemRebarSymAsymIntSurf(b,...
    h,rec,AcSecElm,E,npdiag,fdpc,betac,height,wac,...
    RebarAvailable,load_conditions,ductility,puCostCardBuild,dataCFA,...
    plotRebarDesign);
end
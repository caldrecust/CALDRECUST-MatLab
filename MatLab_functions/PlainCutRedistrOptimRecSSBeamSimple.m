function [minimumFitness,bestLenRebar,bestsepRebar,bestNbCombo9,bestEffLeft,bestEffMid,...
    ...
    bestnblowRight,bestdblowRight,bestCFA,constr]=PlainCutRedistrOptimRecSSBeamSimple...
...
[sepMin3r,~]=sepMinMaxHK13([dbcRight(3)],hagg,0);

sepMinr=[sepMin1r,sepMin2r,sepMin3r];
sepMin(7:9)=sepMinr;

abr3=pi/4*dbcRight.^2;
dbc9=[dbl3,dbm3,dbcRight];
...
ld1r=anchorLenBarTen(fcu,fy,h,hrec,dbcRight(1));
ld2r=anchorLenBarTen(fcu,fy,h,hrec,dbcRight(2));
ld3r=anchorLenBarTen(fcu,fy,h,hrec,dbcRight(3));

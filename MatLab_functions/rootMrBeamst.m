function [raiz]=rootMrBeamst(c1,c2,fr,Es,fy,tdistr,...
                                tlist,h,b,Cc,fcu,ea)
...
[Mr,Fr]=strElasConcISRecBlock(c1,fcu,h,b,Cc,fy,Es,tdistr,tlist);

frt=Fr;
root1=fr-frt;

%%%%%%%%%%%%%%%%%%%%%% f(u) %%%%%%%%%%%%%%%%%%%%%%% 
[Mr,Fr]=strElasConcISRecBlock(c2,fcu,h,b,Cc,fy,Es,tdistr,tlist);
...
[Mr,Fr]=strElasConcISRecBlock(c,fcu,h,b,Cc,fy,Es,tdistr,tlist);

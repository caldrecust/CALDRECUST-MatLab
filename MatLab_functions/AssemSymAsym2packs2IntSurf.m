function [h,bestArea,bestEf,bestdiagram,bestArrangement,bestDisposition,...
    bestMr,bestcxy,bestCP,bestCost,bestLoad,bestCFA]=AssemSymAsym2packs2IntSurf...
    (b,h,rec,Ac_sec_elem,E,npdiag,fdpc,beta1,height,wac,RebarAvailable,...
...
% symmetrical or asymmetrical over a column cross-section in packages of
% two rebars.
% ------------------------------------------------------------------------
%
...
while noptions==0
    ...
    Asym2packSym4DiamIntSurf(b,h,rec,Ac_sec_elem,E,npdiag,fdpc,beta1,...
    ...
    [Mr_col2,h,bestArea2,bestCost2,bestdiagram21,bestnv,Ef_sec_col2,...
    bestArrangement2,bestDisposition2,nv4,bestcxy2,bestCP2,bestLoad2,...
    bestCFA2]=Asym2pack1DiamIntSurf(b,h,rec,Ac_sec_elem,npdiag,fdpc,fy,...
    beta1,load_conditions,RebarAvailable,height,wac,ductility,...
    ...
    [Mr_col3,h,bestArea3,bestCost3,bestdiagram31,bestnv,Ef_sec_col3,...
    bestArrangement3,bestDisposition3,nv4,bestcxy3,bestCP3,bestLoad3,...
    bestCFA3]=Asym2pack4DiamIntSurf(b,h,rec,Ac_sec_elem,npdiag,fdpc,beta1,fy,...

function [volRebar,volRebarSpans,LenRebarL,LenRebarM,LenRebarR,sepRebarSpans,EffSpans,...
  ...
  SAMOOptimMSFSBeamsRebarBasic(b,h,span,brec,hrec,hagg,pmin,pmax,sepMin,...
...
for i=1:nspans
    ...
    dbTopMid,nblowRight,dblowRight,CFA,cc]=SACutRedistrOptimRecBeam1DSec...
    (load_conditions(i,:),fcu(i),Es,h(i),b(i),span(i),dbc,hagg,brec,hrec,...
    pmin,pmax,sepMin,cutxLoc(i,:),Wfac,nblm,Aos3);

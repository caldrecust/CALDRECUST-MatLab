function [raiz]=rootMrBeamsRebarTBeams(c1,c2,fr,Es,fy,distrRebar,...
                                listRebarDiam,h,hf,bw,span,hrec,fcu,ea)
...
[Mr,Fr]=strElasConcBarsTBlock(c1,fcu,h,hf,bw,span,hrec,fy,Es,distrRebar,listRebarDiam);

root1=fr-Fr;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% f(u) %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
[Mr,Fr]=strElasConcBarsTBlock(c2,fcu,h,hf,bw,span,hrec,fy,Es,distrRebar,listRebarDiam);
...
[Mr,Fr]=strElasConcBarsTBlock(c,fcu,h,hf,bw,span,hrec,fy,Es,distrRebar,listRebarDiam);

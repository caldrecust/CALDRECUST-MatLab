function plotTbeam1sec(bw,h,b,hf,barDiamList,distrRebar,nfig)

%------------------------------------------------------------------------
% Syntax:
% TbeamReinforcedSection(bp,ht,ba,ha,dispositionRebar,barTypes1,,...
% barTypes2,rebarAvailable)
%
%------------------------------------------------------------------------
% SYSTEM OF UNITS: Any
%------------------------------------------------------------------------

...
%% Training parameters
nheadsparamnNLclass=load("nHead_nLay_GNN_MOConstrucT5_4000.mat");
paramNLclass=load("nLay_GNN_MOConstrucT5_4000.mat");
...
function Y = modelNL(paramnNL,X,A,numHeadsNL)
    ...
    for i=1:size(Y,1)/3; if Y(i*3,1)==3; Y(i2,1)=2; end; end

function [volRebarSpans,LenRebarL,LenRebarM,LenRebarR,sepRebarSpans,db9Spans,...
  ...
  GNNOptimMSFSBeamsRebarSimple(b,h,span,brec,hrec,hagg,pmin,pmax,rebarAvailable,...
...
for i=1:nspans
    ...
    bestnbcut3sec,nblowRight,dblowRight,CFA]=GNNPSOBeamsRebarLM1DLayer...
    ...
    nblowRight,Ao3(i1:i2,1),Wfac,pltOptConv,i,nMaxIter,numberOfParticles);
    bestnbtLMR
    db9Spans(i,:)=bestdbc;

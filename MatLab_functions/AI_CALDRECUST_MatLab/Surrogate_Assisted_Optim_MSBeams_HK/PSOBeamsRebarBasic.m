...
for j=1:nMaxIter
    ...
    for i=1:numberOfParticles
        ...
        if nblo>3*nbmaxl
            ...
            elseif nblo>nbmaxl
                ...
                if nblo-nb1l>nbmaxl
                    ...
                    if mod(nb2l,2)==0 && mod(nb3l,2)~=0
                        nb3l=nb3l+1;
                    end
                elseif nblo-nb1l==nbmaxl
                    nb2l=nbmaxl;
                    nb3l=0;
                elseif nblo-nb1l<nbmaxl
                    nb2l=nblo-nb1l;
                    nb3l=0;
                    if mod(nb1l,2)==0 && mod(nb2l,2)~=0
                        nb2l=nb2l+1;
                    end
                end
            end
        ...
        nbmo=ceil(Aos3(2)/abc(2)); % minimum required number of bars for left cross-section
        if nbmo<2
            nbmo=2;
        end
        ...
        if nbmo>3*nbmaxm
            ...
            elseif nbmo>nbmaxm
                ...
                if nbmo-nb1m>nbmaxm
                    ...
                    if mod(nb2m,2)==0 && mod(nb3m,2)~=0
                        nb3m=nb3m+1;
                    end
                elseif nbmo-nb1m==nbmaxm
                    nb2m=nbmaxm;
                    nb3m=0;
                elseif nbmo-nb1m<nbmaxm
                    nb2m=nbmo-nb1m;
                    nb3m=0;
                    if mod(nb1m,2)==0 && mod(nb2l,2)~=0
                        nb2m=nb2m+1;
                    end
                end
            end

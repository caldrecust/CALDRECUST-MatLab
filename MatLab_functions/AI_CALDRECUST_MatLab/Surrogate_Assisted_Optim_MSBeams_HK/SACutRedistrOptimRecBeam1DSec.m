function [minimumFitness,bestLenRebar,bestsepRebar,bestNbCombo9,bestEffLeft,bestEffMid,...
    ...
    bestnblowRight,bestdblowRight,bestCFA,constr]=SACutRedistrOptimRecBeam1DSec...
    (load_conditions,fcu,Es,h,b,span,dbc,hagg,brec,hrec,pmin,pmax,sepMin,...
    cutLoc,Wfac,nblm,Aos3)
...
[Abr,EffRight,MrRight,cRight,nbarsRight,sepRebarRight,ListDiamRight,...
 RebarDistrRight]=SAPSOBeamsRebarR1DSec(Mur,fcu,h,b,hagg,brec,hrec,pmin,...
 pmax,sepRebarLeft,redistrRebarM2R,relistRebarM2R,nbAfterCut3L,nb3l,db1l,Aos3);

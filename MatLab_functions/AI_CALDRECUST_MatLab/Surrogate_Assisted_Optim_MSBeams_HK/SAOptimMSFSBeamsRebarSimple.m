function [volRebar,volRebarSpans,LenRebarL,LenRebarM,LenRebarR,sepRebarSpans,EffSpans,...
  ...
  CSrebar,ccSpans]=SAOptimMSFSBeamsRebarSimple(b,h,span,brec,hrec,hagg,pmin,...
...
for i=1:nspans
    ...
    [nb1l,nb2l,nb3l,isfeasible]=nbSimple3D3L(nbmaxl,Aos3(1,1),abc(1:3),nbcc);
    ...
    [nb1m,nb2m,nb3m,isfeasible]=nbSimple3D3L(nbmaxm,Aos3(2,1),abc(4:6),nblow);
    ...
    nblowRight,nbTopMid,nblowLeft,CFA,cc]=SAMSBeamsRebarLM1DLayer(b(i),h(i),...
    ...
    if i<nspans
        if Aos3(3,1)>Ao3(i2+1,1)
            ...
            [vSep,vmaxSepm]=sepMinMaxHK13(dbc(1:3),hagg,1);
            [nbnew1,nbnew2,nbnew3,Abcut]=BendCutRebarSecBeamAs1DiamLayer...
                (NbCombo9(7:9),dbc(1:3),Ao3(i2+1,1),b(i),h(i),hrec,vSep);

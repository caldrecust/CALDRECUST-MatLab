function [raiz]=bisectionMr3LayerBeamsRebar(cUno,cDos,fr,E,distrRebar,...
    listRebarDiam,h,b,b_rec,h_rec,vSep,fdpc,beta,ea)

%------------------------------------------------------------------------
% Syntax:
% [raiz]=bisectionMr3LayerBeamsRebar(cUno,cDos,fr,E,t1,t2,h,b,b_rec,h_rec,...
%                           fdpc,beta,ea)
%
%-------------------------------------------------------------------------
% SYSTEM OF UNITS: Any.
...
[eleMec]=eleMecanicos3LayerBeamsBar(cUno,aUno,fdpc,h,b,...
    E,distrRebar,listRebarDiam);

frt=eleMec(1,1)+eleMec(2,1);
raizUno=fr-frt;

%%%%%%%%%%%%%%%%%%%%%% f(u) %%%%%%%%%%%%%%%%%%%%%%% 
[eleMec]=eleMecanicos3LayerBeamsBar(cDos,aDos,fdpc,h,b,...
    E,distrRebar,listRebarDiam);
...
a=beta*c;
[eleMec]=eleMecanicos3LayerBeamsBar(c,a,fdpc,h,b,...
    E,distrRebar,listRebarDiam);

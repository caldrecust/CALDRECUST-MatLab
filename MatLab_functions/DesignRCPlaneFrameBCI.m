function [totalWeightStruc,wsteelColsTotal,pacColsElem,Mp,dimensions,...
    ...
    wsteelStructure]=DesignRCPlaneFrameBCI(puBeams,puCols,puColBuild,...
    rangeCFA,lenElem,fcElem,inertiaElem,qadm,FSfootings,nodesSupportColumns,...
    puSteelFootings,dimensions,fcbeams,fccols,fcfootings,areaElem,...
    colsSymAsymISR,rebarAvailable,conditionCracking,duct,elem_cols,...
    elem_beams,recCols,load_conditions_beams,load_conditions_columns,...
    reactions,shearbeam,coordBaseCols,coordEndBeams,coordBaseFooting,...
    directionData)
%% Documentation:
%------------------------------------------------------------------------
% Syntax:
...
%
%         puCols:                       is the average unit construction
%                                       cost for the reinforcing bar assembly.
%                                       
%         puColBuild:                   parameters (unit material costs)
%                                       for the calculation of the unit
%                                       cost of a rebar design.
%
...
for i=1:ncols
    ...
    AcSecCols,EfsecCol,Mr_col,bestCFA]=isrColumnsSymAsym(puCols,height,b,h,recCols,...
    fy,fc,loadCol,colsSymAsymISR,conditionCracking,duct,wac,rebarAvailable,...
    puColBuild,rangeCFA,optimaColConvPlot,plotISRColResults,plotRebarDesign);

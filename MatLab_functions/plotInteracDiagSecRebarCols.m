function plotInteracDiagSecRebarCols(loadConditions,diagram,distrRebar,...
                        h,b,barDiamList)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
xcondicion=abs(loadConditions(:,4));
ycondicion=loadConditions(:,2);
figure(8)
plot(x,y,'k')
legend('Nominal')
...
plot(xcondicion,ycondicion,'r o','linewidth',0.05,'MarkerFaceColor','red',...
    'DisplayName','Load Condition')
axis([0 diagram(fix(npts/2)+1,3)*2 diagram(1,1) diagram(npts,1)]);

function [diagrama,mexef,eficiencia,cxy]=diagramasDisposicion(As,b,h,E,...
    npuntos,fdpc,nv,beta,ov,av,disposicion_varillado,load_conditions)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%% Eficiencies %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load_conditions(:,3:4)=abs(load_conditions(:,3:4)); % by only consisering
                                                    % positive moments is
                                                    % enouth for symmetric
                                                    % designs -----------
[mexef,eficiencia,cxy]=effRecColsLinearSearch(diagrama,load_conditions,...

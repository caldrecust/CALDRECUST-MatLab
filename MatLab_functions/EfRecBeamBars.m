function [Eff,Mrt,c]=EfRecBeamBars(Mu,fcu,Es,fy,h,b,distrRebar,...
                                     listRebarDiam,hrec)

%------------------------------------------------------------------------
% Syntax:
% [Eff,Mrt,c]=EfRecBeamBars(Mu,fcu,Es,fy,h,b,distrRebar,listRebarDiam,hrec)
%
%-------------------------------------------------------------------------
% SYSTEM OF UNITS: Any.
%
...
cDos=h;
fr=0;
[Root]=rootMrBeamsRebar(cUno,cDos,fr,Es,fy,distrRebar,...
    listRebarDiam,h,b,hrec,fcu,0.001);  

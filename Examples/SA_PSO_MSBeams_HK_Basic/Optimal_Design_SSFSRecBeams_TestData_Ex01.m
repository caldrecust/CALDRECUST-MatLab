...
for nd=1:ndl  % loop on vector of data size
    ...
    if model2Use=="PIGCNN"
        ...
        Ao3=model1fc2GAT1Conv1fc(paramPIGCNN.pignn,XTest,ATest,nheadsparamnGATPIGNN.numHeads);
    else
    ...
    for reps=1:nreps % loop on data
        ...
        title({strcat('True Solution vs ',model2Use, '-PSO solution (Basic RP):'),'Optimum rebar area of a Beam',...

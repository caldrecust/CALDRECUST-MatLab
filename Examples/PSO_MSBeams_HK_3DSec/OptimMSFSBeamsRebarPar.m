function [volRebarSpans,LenRebarL,LenRebarM,LenRebarR,sepRebarSpans,db9Spans,...
  ...
  OptimMSFSBeamsRebarPar(b,h,span,brec,hrec,hagg,pmin,pmax,rebarAvailable,fcu,...
  load_conditions,fy,wac,cutxLoc,Wfac,pltOptConv,pltOptReb,span2Plt)
...
for i=1:nspans
    ...
    bestnbcut3sec,nblowRight,dblowRight,CFA]=PSOBeamsRebarLM1DLayerPar...

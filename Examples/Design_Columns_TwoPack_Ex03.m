...
%    allowed. ONly one rebar diameter is allowed. Their distribution can be
%    either symmetrical or asymmetrical.
%
%    Note: function "Asym2pack1Diam" is used.
%
%----------------------------------------------------------------
%
...
%% Loads
load_conditions=[1 -53.52e3 -35.602e5 39e5]; % [nload, Pu, Mx, My]
